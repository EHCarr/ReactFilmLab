...
In yesterday's lesson you saw how to use HTML forms and Express middleware, such as:
...
The goal of the lab is to do put in a rep doing everything that you did during the _Express - API - CRUD_ lesson by adding the following functionality to the `express-dev-skills` project:
...
- In lecture, we did not go over the use of the `method-override` middleware. However, if you would like to require, mount and use it, please do.
