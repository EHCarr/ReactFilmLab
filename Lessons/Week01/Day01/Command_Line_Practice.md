...
Follow the episodes below!

Create a folder called command-line-practice anywhere in your GA folder

* **IMPORTANT: After you've created the folder you need to `cd` into that directory.**  (The directory should be called `command-line-practice`.)
...
* Also in the `command-line-practice` directory, create another directory called called `star_wars` and create a file called `commands.txt`.  You will now have the `commands.txt` file and the `star_wars` directory and this `README.md` file side by side in the directory that was created when you cloned this assignment.
