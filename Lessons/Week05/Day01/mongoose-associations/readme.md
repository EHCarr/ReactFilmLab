...
# Implementation: Embedded for Blog App
## Model Changes
- Update Article.js model file and add Author model in that file.
...
- Be bold to incorporate the article.js into author.js and use your knowledge of shortcuts to make a new controller for author.

## Create an Author Router
- Similarly, to make author routes in a smart way, incorporate the articles.js into authors.js and use your knowledge of shortcuts to make a new router for author.

<br>

# Implementation: Referenced for Blog App
- Author Schema
```
const mongoose = require('mongoose');
...
# Hints for you Homework/ Deliverable
...
- Complete you Recipe web application (or the one you started with your own idea) by coverting into M to M (Referenced) as explained in the lecture.
