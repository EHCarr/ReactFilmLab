...
Let's fork and clone the blog app. As we're going to be adding authentication on top of it. As we're going to be adding authentication on top of it.
...
## LAB (Deliverable)
- Add Authentication and Authorization on top of your Recipe web app (or the one you have completed with your own idea as a deliverable in unit 2), as explained in todays lecture.
