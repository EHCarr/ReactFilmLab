...
In pairs, pick one of the following sites and draw a basic sketch for
...
- *“Wants to”:* Here we’re describing their intent. What is it they’re actually trying to achieve? This statement should be implementation free — if you’re describing any part of the UI and not what the user goal is you're missing the point.
...
- [Mockplus](https://www.mockplus.com/), a workflow play form with
  high-fidelity prototyping tools.
